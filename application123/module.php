<?php 
 ...
 <?php 
    ...
    $req2 =$db->query("SELECT e.nomEns,e.prenomEns,s.nomSpe FROM enseignants e,specialites s WHERE e.idEns=s.idEns")
...
<div class="col-sm-12 text-center">
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <h2 class="m5050"> <span class="en"><strong>Specialité</strong></span> </h2>
          </div>
          ...
          <div class="panel-body p5555">
            <div class="col-xs-12 col-sm-12 text-center">
              ...
              <div class="col-sm-12">
                ...
                <tr>
                <?php while($spe = $req2->fetch()):?> 
               
                <tr>
                <td><?php echo $spe->nomEns ?></td>
                <td><?php echo $spe->prenomEns?></td>
