...
require_once 'inc/functions.php';
 ...
 if(!empty($_POST['to']) && isset($_POST['to'])){
     ...
     $de =$db->query("SELECT nomEns,prenomEns,photoEns FROM enseignants WHERE idEns =?",[$idEtudiant]);
              ...
              <?PHP  while($affiche = $de->fetch()):?>
                    ...
                    <!--Form with header-->
                        ...
                        <div class="card border-primary rounded-0">
                            ...
                            <img 
                           <?php
                             if ($affiche->photoEns == "photos/" ){ ?>
                                src="img/no_photo_m.png"<?php }else {?>
                                  src="<?= $affiche->photoEns ?>" 
                                  <?php }?>
                                   alt="..." height="" width=" "> 
                            ...
                            <form action="" method="post" class="formulaire">
                                ...
                                <div class="text-center">
                                    <input type="submit" value="envoyer" class="btn btn-success btn-block rounded-0 py-2" onclick="Envoyer(<?php echo $idEtudi ant ?>);"/>
                                </div>
                            </div>
                            </div>
                        </div>
...
$(document).ready(function(){
    ...
    $('.formulaire').submit(function(){
       ...
       $.post('envoiEt.php',{toE:val1,messagesE:message},function(donnees){
